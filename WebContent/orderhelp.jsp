...
<body style='background:transparent'>
    ...
    <div id='contain' style='width:900px;background:rgb(255,255,255);margin:0px auto;padding:0px'>
        ...
        <div id='top' style='width:900px;height:108px;background:none transparent scroll repeat 0% 0%'>
            ...
            <div id='pdv_3428' class='pdv_class' style='width:900px;height:41px;top:65px;left:0px; z-index:1'>
                <div id='spdv_3428' class='pdv_top' style='overflow:hidden;width:100%;height:100%'>
            ...
            <div id='pdv_3427' class='pdv_class' style='width:395px;height:25px;top:0px;left:495px; z-index:3'>
                <div id='spdv_3427' class='pdv_top' style='overflow:hidden;width:100%;height:100%'>
                    <div class="pdv_border" style="margin:0;padding:0;height:100%;border:0px  solid;background:;">
                        <div style="height:25px;margin:1px;display:none;background:;">
                            <div style="float:left;margin-left:12px;line-height:25px;font-weight:bold;color:">
            ...
            <div id='pdv_3431' class='pdv_class' title='' style='width:210px;height:100px;top:0px;left:0px; z-index:5'>
                <div id='spdv_3431' class='pdv_top' style='overflow:hidden;width:100%;height:100%'>
                    <div class="pdv_border" style="margin:0;padding:0;height:100%;border:0px  solid;background:;">
                        <div style="height:25px;margin:1px;display:none;background:;">
                            <div style="float:left;margin-left:12px;line-height:25px;font-weight:bold;color:">
                    ...
                    <div class="pdv_border" style="margin:0;padding:0;height:100%;border:0px  solid;background:;">
                        ...
                        <div style="padding:10px">
                            <div id='pagecontent' class='page_content'>
                                &nbsp;&nbsp;&nbsp; 欢迎来到我们的网上快餐店，如果您是第一次来，不知道该如何进行网上订餐的话，那我来给您介绍一下：
                                <br />&nbsp;&nbsp;&nbsp; 首先，请您在我们列出的餐品中挑选您所需要的，并将餐品加入订餐车，然后在订餐车提交后完成订单，如果您是我们网站的会员的话，可以登录会员（登录会员后不仅可以自动按照您的订单项目填写信息，更可以根据您所选餐品获得积分，积分可以到我们的换赠区去换取礼品哦），也可以以非会员的方式继续填写订单项目，提交后生成订单，您可以到我们指定的页面去查看您的订单。好了，现在请您享受足不出户的网上快餐美味吧。
                                <br />
                                <br />
                                <img alt="" src="images/1254038036.gif" border="0" />
                            </div>
                            <script>
