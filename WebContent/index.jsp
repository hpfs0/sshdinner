                                ...
                                <div id="dingcantime2">
                                    ...
                                    <div style="padding:px;">
                                        ...
                                        <div class="dingcantimeinfo">
                                            <div style="height:24px;font-size:14px;font-weight:bold;"><font style="color:#ef6906;">午餐：</font><font style="color:#404040;">9:00&nbsp;-&nbsp;13:00</font>
                                            </div>
                                            <div style="height:24px;font-size:14px;font-weight:bold;"><font style="color:#ef6906;">晚餐：</font><font style="color:#404040;">16:00&nbsp;-&nbsp;19:00</font>
                                            </div>
                            ...
                            <div style="margin:0px 3px;padding:10px;">
                                ...
                                <ul class="newslist_time2">
                                    ...
                                    <li class="newslist_time2">
                                        <div class="time">09/27</div><a href="news/html/?297.jsp" target="_self" class="newslist_time2">金秋来临，菜品赠品大升级</a>
                                    </li>

                                    <li class="newslist_time2">
                                        <div class="time">09/27</div><a href="news/html/?296.jsp" target="_self" class="newslist_time2">积分换电影票，奖品大变样</a>
                                    </li>

                                    <li class="newslist_time2">
                                        <div class="time">09/27</div><a href="news/html/?295.jsp" target="_self" class="newslist_time2">精品盖浇饭上市喽</a>
                                    </li>

                                    <li class="newslist_time2">
                                        <div class="time">09/27</div><a href="news/html/?294.jsp" target="_self" class="newslist_time2">10月团体订餐优惠活动开始</a>
                                    </li>

                                    <li class="newslist_time2">
                                        <div class="time">09/27</div><a href="news/html/?293.jsp" target="_self" class="newslist_time2">节日放假通知</a>
                                    </li>
                                ...
                                <div id="dingcanall2">
                                    ...
                                    <div id="dingcanall_top">
                                        ...
                                        <div id="dingcanall_top_mid">
                                            <div>
                                                <div id="tt_01" class="dingcanall_menunow" style="display:block;" onmouseover="changeBq('01','02','03');">自选订餐</div>
                                                <div id="tt_02" class="dingcanall_menu" style="display:block;" onmouseover="changeBq('02','01','03');">固定套餐</div>
                                                <div id="tt_03" class="dingcanall_menu" style="display:block;" onmouseover="changeBq('03','02','01');">组合套餐</div>
                                            </div>
                                        </div>
